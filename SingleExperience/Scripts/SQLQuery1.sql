...
---Cpf into CreditCard
ALTER TABLE CreditCard ADD CONSTRAINT FK_CreditCard_Client
...
---Cpf into Bought
ALTER TABLE Bought ADD CONSTRAINT FK_Bought_Client
FOREIGN KEY (Cpf) REFERENCES Client (Cpf);
...
INSERT INTO Client (Cpf, Name, Phone, Email, BirthDate, Password)
	VALUES (10328698954, 'Mariane Karoline dos Santos', '995427605', 'nani@email.com', '05/07/1998', '123456');
